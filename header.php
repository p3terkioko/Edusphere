		...
		<header id="header" class=" full-header" data-sticky-class="not-dark">
			...
			<div id="header-wrap">
				...
				<div class="container clearfix">
					...
					============================================= -->
					<div id="logo">
						<a href="index.php?pag=home" class="standard-logo" data-dark-logo="images/edusphere1.png"><img src="images/edusphere1.png" alt="Exceptional Logo"></a>
						<a href="index.php?page=home" class="retina-logo" data-dark-logo="images/edusphere1.png"><img src="images/edusphere1.png" alt="exceptional Logo"></a>
					</div><!-- #logo end -->
						...
						<ul>
							...
							<li><a href="index.php?page=course"><div>Courses</div></a>
								<ul>
									...
									<li><a href="index.php?page=course"><div><i class="icon-line-layout"></i>Computer Science</div></a></li>
